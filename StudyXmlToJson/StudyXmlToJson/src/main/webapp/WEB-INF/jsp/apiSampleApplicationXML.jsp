...
function getAddrLoc(){
    ...
    $.ajax({
        ...
        ,success:function(jsonStr){
            //console.log(JSON.stringify(jsonStr)); //API의 데이터 객체출력.
            $("#list").html("");
...
<input type="hidden" name="confmKey" id="confmKey" style="width:250px;display:none" value=""/><!-- 요청 변수 설정 (승인키) -->
...
<div><ul id="pagingul" ></ul></div><!-- 페이징 출력 영역 -->
</form>
</body>
</html> 	